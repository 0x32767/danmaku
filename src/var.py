...
EVENT_BULLET_DIE = pg.USEREVENT + 4
EVENT_ENEMY_POSITION = pg.USEREVENT + 5
EVENT_SHOW_ENEMY = pg.USEREVENT + 6
EVENT_HIDE_ENEMY = pg.USEREVENT + 7
EVENT_MAKE_PARTICLE = pg.USEREVENT + 8
